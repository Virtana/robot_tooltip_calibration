...
public class RobotController : MonoBehaviour
{
  ...
  private float _newAngle = 0.0f; //each angle to be loaded into the joint on each iteration of the loop

  //File to read joint positions from
  private string[] _textLines = System.IO.File.ReadAllLines(@"seeessveedata.csv"); 
